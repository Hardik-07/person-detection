...
## Requirments
  ...
  - Clone the AlexeyAB/darknet repsoitry  
  - openCV
  - Test Image 
  - Test video file
...
##Steps
  ...
  - execute all the cells consecutively to see the Results.
  - It will give an Result video in which the bounding boxes will be drawn around the different objects
